...
export const p_estadisticas_genero = () => {
    ...
    p_total_genero.textContent = "Total de Mujeres: " + personajes_genero(data_personajes).total_mujeres  + " Total de hombres: " +  personajes_genero(data_personajes).total_hombres;
