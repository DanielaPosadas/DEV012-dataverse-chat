...
import {
  p_estadisticas,
  p_estadisticas_genero,
} from "../components/estadisticas.js";
...
const inicio_home = () => {
  ...
  //SELECCIONAR <SELECT>
  const filtrarLetalidad = div_home.querySelector(
    '[id="filtrar-por-letality"]',
  );
  ...
  function filtros() {
    ...
    const dataFiltrada = filtros_acumulables(
      data_personajes,
  ...
  imagebtnGrupalResponsive.src =
    "https://cdn-icons-png.flaticon.com/512/59/59045.png";
  ...
  imageConfigApikey.src =
    "https://cdn.icon-icons.com/icons2/1369/PNG/512/-settings_90618.png";
